...
insert into APPLICATION (APP_ID, APP_SCHEME, APP_HOSTNAME, APP_PORT, APP_URL_PATH, FK_APPVM_ID) values
(1, 'http', 'vm0100.example.com', 8080, '/rest/bluegreen', 1);
...
insert into PHYSICAL_DATABASE (PHYSICAL_ID, PHYSICAL_TYPE, DRIVER_CLASS_NAME, PHYSICAL_INST_NAME,
                               IS_LIVE, `PASSWORD`, URL, USERNAME, FK_LOGICAL_ID) values
(1, 'RDS', 'com.mysql.jdbc.Driver', 'my-rds-instance', 1, 'abc123',
 'jdbc:mysql://my-rds-instance.wwcckkadf.us-west-2.rds.amazonaws.com:3306/dbname', 'admin', 1);
