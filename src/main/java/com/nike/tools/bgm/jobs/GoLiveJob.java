...
import com.nike.tools.bgm.tasks.FixedElbzFlipEc2zTask;
...
public class GoLiveJob extends TaskSequenceJob
{
  ...
  private void instantiateTasks()
  {
     ...
     */
    tasks.add(applicationContext.getBean(FixedElbzFlipEc2zTask.class).assign(position++, oldLiveEnv, newLiveEnv, fixedLbName));
