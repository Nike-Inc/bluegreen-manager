...
import com.nike.tools.bgm.tasks.RdszSnapshotRestoreTask;
...
public class StagingDeployJob extends TaskSequenceJob
{
  ...
  private void instantiateTasks()
  {
    ...
    tasks.add(applicationContext.getBean(RdszSnapshotRestoreTask.class).assign(position++, liveEnv, stageEnv, dbMap));
